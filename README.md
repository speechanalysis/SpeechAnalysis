...
![ttsfinal](https://github.com/speechanalysis/Speechanalysis/blob/main/screenshots/ttsfinal.gif)
...
Όσον αφορά το 4ο Παραδοτέο, ερχόμενοι από την ολοκληρωμένη υλοποίηση ενός media player για τα ηχητικά αρχεία που υποστηρίζει η εφαρμογή μας, εστιάσαμε στo compile του 
συνόλου των λειτουργιών που προσθέσαμε με την πάροδο του μαθήματος σε ένα ολοκληρωμένο Standalone App, να διορθώσουμε τυχόν ατέλειες σε αυτές καθώς και να σχηματίσουμε 
την τελική μορφή της εφαρμογής, τόσο στο εμφανισιακό(GUI) όσο και στο λειτουργικό κομμάτι.
...
Αυτό γίνεται επειδή η λειτουργία speech to text είναι λειτουργική μόνο με ηχητικά τύπου flac και wav. Για αυτόν τον λόγο βάλαμε και έλεγχο στο speech to text button, 
σε περίπτωση που ο χρήστης δώσει κάποιο άλλο τύπο ηχητικού αρχείου εκτός από wav και flac, τότε να του εμφανίσει σχετικό μήνυμα που να ειδοποιεί τον χρήστη για το 
λάθος αρχείο που έδωσε.
...
[Mathworks - fileparts](https://www.mathworks.com/help/matlab/ref/fileparts.html) [7]
