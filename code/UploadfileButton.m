function UploadfileButtonPushed(app, event)
            ...
            [filepath,name,ext] = fileparts(file); % returns the path name, file name, and extension about the specified file
            if strcmp(ext,'.wav') | strcmp(ext,'.flac'); %elgxos mese strcmp ean oi symboloseira ext einai idia me thn symboloseira wav h me thn flac
                app.file=file; %pernaei to file poy epelexe o xrhsths se mia metablhth poy tha mporoyn na blepoyn thn timh ths kai alles synarthseis toy app
            else
